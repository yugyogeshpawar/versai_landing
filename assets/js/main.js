...
// versai jquery
    ...
    $('.tgmenu__navbar-wrap .navigation > li.menu-item-has-children > a').on('click', function (e) {
        e.preventDefault(); // Prevent default link behavior
        var $dropdown = $(this).next('.mydrop-item');

        // Close other open dropdowns
        $('.mydrop-item').not($dropdown).slideUp();
...
// ++++++++++++++++++++++++++++++++++++
  ...
  const careerBtn = document.querySelector('.apply-career');
  const internBtn = document.querySelector('.apply-intern');

  careerBtn.addEventListener('mouseenter', () => {
    internBtn.classList.remove('apply-active');
    careerBtn.classList.add('apply-active');
  });

  careerBtn.addEventListener('mouseleave', () => {
    internBtn.classList.add('apply-active');
    careerBtn.classList.remove('apply-active');
  });
